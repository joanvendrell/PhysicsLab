...
Web-based interface that allows users to run physics simulations (including but not limited to heat transfer and solid mechanics) directly from natural language prompts. For example, a user might type: **“Simulate the heat transfer through a thin 30 nm conductor.”**

## Approach

We adopt an **agentic architecture** (e.g., master-agent loops and MCPs) to orchestrate the simulator.
